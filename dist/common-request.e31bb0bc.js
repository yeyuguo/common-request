...
},{"../utils":"node_modules/axios/lib/utils.js","buffer":"../../../.config/yarn/global/node_modules/node-libs-browser/node_modules/buffer/index.js"}],"node_modules/axios/lib/core/settle.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/plugin-register.js":[function(require,module,exports) {
"use strict";
 ...
 * */
var PluginRegister = /*#__PURE__*/function () {
  function PluginRegister(context, lastNext) {
  ...
  */
  ...
  _createClass(PluginRegister, [{
    ...
    key: "useTap",
    value: function useTap() {
      return this;
    } // 熔断机制, 下一个的执行依赖上一个执行

  }, {
    key: "useFused",
    value: function useFused(plugin) {
      this.middleware = this.middleware.concat(plugin);
      return this;
    }
    /**
...
exports.mockRequestColor = mockRequestColor;
...
function defaultHandle(response) {
  if (response instanceof Promise) return response; // todo 丰富返回值， 只返回接口值

  response = response.data;
}

function commonError(response, next) {
...
function loginHandle(response, next) {
  // 未登录
  var _ref = response || {},
      data = _ref.data;
  ...
  if (codeLogin.includes(data.code)) {
    ...
    var _location2 = location,
        href = _location2.href; // 追加参数 isLogin=1
...
function mockRequestColor(_ref2) {
  var mockBaseURL = _ref2.mockBaseURL,
      method = _ref2.method,
      functionId = _ref2.functionId,
      params = _ref2.params;

  /** functionId 转换 url 的path
   * {functionId, params:{funName}} 转换成mock的url  /functionId/functionName
   */
  var transFunctionID2Url = function transFunctionID2Url(_ref3) {
...
function limitNumber() {// todo
}

function toQuery(obj) {
  return Object.keys(obj).reduce(function (pre, cur) {
    return "".concat(pre).concat(cur, "=").concat(typeof obj[cur] === 'string' ? obj[cur] : JSON.stringify(obj[cur]), "&");
  }, '').replace(/&$/, '');
} // todo 走接口防抖限制
...
function debounce(func, wait, immediate) {
  ...
  return function () {
    ...
    if (callNow) {
      result = func.apply.apply(func, [context].concat(_toConsumableArray(args)));
      context = args = null;
    }
...
},{}],"src/axios-request.js":[function(require,module,exports) {
var define;
"use strict";
...
var _pluginRegister = _interopRequireDefault(require("/src/plugin-register"));
...
instance.interceptors.response.use( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(response) {
    var config, plugins, instance;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            config = response.config;
            plugins = [_plugin.loginHandle];

            if (config.selfOption && config.selfOption.isErrorTip) {
              plugins = [_plugin.loginHandle, _plugin.commonError];
            } // const instance = new PluginRegister(response, defaultHandle) // defaultHandle 无法处理


            instance = new _pluginRegister.default(response);
          ...
          case 11:
            return _context.abrupt("return", response ? response.data : {});
...
function colorParams(_ref2) {
  var url = _ref2.url,
      method = _ref2.method,
      functionId = _ref2.functionId,
      appid = _ref2.appid,
      loginType = _ref2.loginType,
      params = _ref2.params,
      isEncode = _ref2.isEncode;
  var query = {
    functionId: functionId,
    appid: appid,
    loginType: loginType,
  ...
  if (method === 'POST') {
    ...
    if (isEncode) {
      data = "body=".concat(params);
    } else {
      data = "body=".concat(JSON.stringify(params));
    }
...
function _default(_ref3) {
  var _ref3$url = _ref3.url,
      url = _ref3$url === void 0 ? '/api?' : _ref3$url,
      _ref3$method = _ref3.method,
      method = _ref3$method === void 0 ? "GET" : _ref3$method,
      functionId = _ref3.functionId,
      params = _ref3.params,
      _ref3$isEncode = _ref3.isEncode,
      isEncode = _ref3$isEncode === void 0 ? false : _ref3$isEncode,
      _ref3$loginType = _ref3.loginType,
      loginType = _ref3$loginType === void 0 ? '2' : _ref3$loginType,
      _ref3$appid = _ref3.appid,
      appid = _ref3$appid === void 0 ? 'u' : _ref3$appid,
      _ref3$mockBaseURL = _ref3.mockBaseURL,
      mockBaseURL = _ref3$mockBaseURL === void 0 ? "//japi.jd.com/mock/902" : _ref3$mockBaseURL;

  var _ref4 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      _ref4$mock = _ref4.mock,
      mock = _ref4$mock === void 0 ? false : _ref4$mock,
      _ref4$isErrorTip = _ref4.isErrorTip,
      isErrorTip = _ref4$isErrorTip === void 0 ? false : _ref4$isErrorTip;

  // 执行 mock 机制
  if (mock) {
    return instance((0, _plugin.mockRequestColor)({
  ...
  var requestParams; //  color 接口

  if (functionId) {
    requestParams = colorParams({
      url: url,
      method: method,
      functionId: functionId,
      appid: appid,
  ...
  return instance(_objectSpread(_objectSpread({
    url: url,
    method: method
  }, requestParams), {}, {
    selfOption: {
...
},{"axios":"node_modules/axios/index.js","/src/plugin-register":"src/plugin-register.js","/src/plugin":"src/plugin.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _axiosRequest = _interopRequireDefault(require("/src/axios-request"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _loop = function _loop(i) {
  console.log('i: ', i); // const mockBaseURL = 'japi.jd.com/mock/902/testrequest'
  // const mockBaseURL = 'japi.jd.com/mock/902/testrequest?type=error'
  // const mockBaseURL = 'japi.jd.com/mock/902/testrequest?type=error'

  var list = [// http://japi.jd.com/mock/902/testrequest?type=success
  // {"code":200,"data":"success"}
  'success', // http://japi.jd.com/mock/902/testrequest?type=error 
  // {"code":400,"message":"错误了"}
  'error'];
  (0, _axiosRequest.default)({
    ...
    console.log("data-".concat(i, ":"), data);
  }).catch(function (error) {
    console.log("error-".concat(i, ":"), error);
  });
};
...
},{"/src/axios-request":"src/axios-request.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/common-request.e31bb0bc.js.map